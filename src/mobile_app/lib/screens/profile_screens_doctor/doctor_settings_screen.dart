...
class SettingScreenDoctor extends StatefulWidget {
  final Function action;
  final Function action2;
  SettingScreenDoctor({required this.action, required this.action2, Key? key})
      : super(key: key);

  @override
  State<SettingScreenDoctor> createState() => _SettingScreenState();
}

class _SettingScreenState extends State<SettingScreenDoctor> {
  void initState() {
    super.initState();
  }
